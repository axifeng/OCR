...
from UI.ppocr.utils.stats import TrainingStats
from UI.ppocr.utils.save_load import save_model
from UI.ppocr.utils.utility import print_dict, AverageMeter
from UI.ppocr.utils.logging import get_logger
from UI.ppocr.utils.loggers import VDLLogger, WandbLogger, Loggers
from UI.ppocr.data import build_dataloader

global train_log_dist
...
def train(config,
    ...
    if amp_custom_black_list is None:
    ...
    for epoch in range(start_epoch, epoch_num + 1):
        ...
        for idx, batch in enumerate(train_dataloader):
            ...
            if dist.get_rank() == 0 and (
                ...
                train_log_dist = {"epoch": epoch, "epoch_num": epoch_num, "global_step": global_step, "logs": logs,
                                  "lr": stats['lr'], "loss": stats['loss'],'bestMetricPath':config['Global']['save_model_dir']}
            ...
            if global_step > start_eval_step and \
                ...
                # global train_log_dist
                # train_log_dist["bestMetric"] = ', '.join([
                #     '{}: {}'.format(k, v) for k, v in best_model_dict.items()
                # ])
                # train_log_dist['bestMetricPath'] = config['Global']['save_model_dir']
